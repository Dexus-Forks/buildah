...
require (
	...
	github.com/containers/common v0.48.1-0.20220510200805-76bcbc8d05b3
...
replace github.com/openshift/imagebuilder => github.com/Dexus-Forks/imagebuilder v1.2.4-0.20220517122812-d01204b3cd37
